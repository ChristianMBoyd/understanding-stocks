...
The authors introduce the {\it Market Information Ratio}, which they define as an index's return minus the daily-rebalanced market return divided by the MTE.  They further claim that delaying updating the shares outstanding data by 1-2 years appears to maximize the MIR.