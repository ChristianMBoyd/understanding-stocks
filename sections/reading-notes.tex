...
In \cite{Fama2015}\ldots

\note{[Todo]}: continue reading from section 2.  Nothing too noteworthy so far, but it does seem to be providing a history lesson in how people have thought of CAPM and pricing models since the 60s and 90s.  At the risk of sounding dismissive, I'm not sure how much of this is parameterizing reality vs. adding sufficiently many parameters to capture a majority of the effect.