...
The Arbitrage Pricing Theory (APT) itself, seems like a generic conceptual framework for how returns ought to be related to intrinsic market factors, and {\it risk premiums} associated with those factors.  I'm having some difficulty making sense of the various representations in the article \cite{APT2026}, but will make my best-effort attempt to summarize my understanding in what follows.  Consider a portfolio of $n$ assets, and the rate of returns on those assets over a fixed period, $r\in\mathbb{R}^n$.  
