...
When introducing the models, I started to consider that the models under discussion are simply adding sufficiently many parameters to capture a majority of the effect.  Funnily enough, this is more or less proposed as an interpretation of the new factors.  They reference \cite{Fama1996} as motivation for considering these five kinds of portfolios or samples, as simply being a means of establishing \ldots