...
\subsubsection{The basics of stock valuation}

At a fundamental level, stock valuation should be determined by a company's equity valuation.  I.e., the stock valuation is given by the ratio of the equity value to the number of shares outstanding.  By {\it shares outstanding}, I mean all company shares (including those that can be issued by exercisable options) except for repurchased shares held in treasury stock.\footnote{From what I can read online, company shares in treasury stock are excluded from dividend payouts and lack voting rights.  They appear to exist only as pre-authorized shares that the company could, in principle, re-issue at will.  For accounting purposes, the purchase price of treasury stock is counted against the shareholder equity, either at the purchase price or par value.}
