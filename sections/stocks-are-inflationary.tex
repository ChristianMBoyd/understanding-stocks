...
In Robert Schiller's lecture series on Financial Markets, he notes in \cite{Schiller2011} that the purpose of owning company stock is to receive dividends.\footnote{More precisely, this perspective is shared at the 31 minute mark of \cite{Schiller2011}.}  This is framed within the context that for-profit corporations exist to return profits to their owners (i.e., shareholders), but noteworthy that the mechanism of profit sharing is through dividends.  Later in \cite{Schiller2011}, however, Schiller does go on to explain that share buybacks are effectively the same in that the value of shares held by the investor is increased due to reducing the number of shares in circulation.\footnote{This perspective is shared around the 50 minute mark of \cite{Schiller2011}.}

Schiller's perspective is focused on the ability of the company to return profits to its shareholders.  In particular, the mechanism of profit return--dividends or stock buybacks--is emphasized, rather than an abstract concept of future profits.  It's not the current assets + future profits that are valued, it's the present value of all future profit returns; i.e., it's focused on the present value of dividend + buyback returns.  Notably, Schiller points out later than shareholder equity should be compared to the stock price, as it makes financial sense to liquidate a company's assets if its market capitalization falls below shareholder equity.\footnote{This discussion appears just before the 1 hour 10 minute mark of \cite{Schiller2011}.}  I note this as it appears more as a means of comparison, rather than as an additional contribution to a company's stock value.  I.e., shareholder equity is used to evaluate a company's business efficacy, rather than making up a component of the company stock price.
